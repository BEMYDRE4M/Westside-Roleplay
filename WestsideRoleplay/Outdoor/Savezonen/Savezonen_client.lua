...
function showSafezone()
	if(getElementData(lp,'inScoreboard')==false)then
		dxDrawText("Westside Roleplay", (screenW * 0.3667) - 1, (screenH * 0.0000) - 1, (screenW * 0.6006) - 1, (screenH * 0.0562) - 1, tocolor(0,200,200, 255), 2.00, "default", "center", "center", false, false, false, false, false)
		dxDrawText("Westside Roleplay", (screenW * 0.3667) + 1, (screenH * 0.0000) - 1, (screenW * 0.6006) + 1, (screenH * 0.0562) - 1, tocolor(0,200,200, 255), 2.00, "default", "center", "center", false, false, false, false, false)
		dxDrawText("Westside Roleplay", (screenW * 0.3667) - 1, (screenH * 0.0000) + 1, (screenW * 0.6006) - 1, (screenH * 0.0562) + 1, tocolor(0,200,200, 255), 2.00, "default", "center", "center", false, false, false, false, false)
		dxDrawText("Westside Roleplay", (screenW * 0.3667) + 1, (screenH * 0.0000) + 1, (screenW * 0.6006) + 1, (screenH * 0.0562) + 1, tocolor(0,200,200, 255), 2.00, "default", "center", "center", false, false, false, false, false)
		dxDrawText("Westside Roleplay", screenW * 0.3667, screenH * 0.0000, screenW * 0.6006, screenH * 0.0562, tocolor(255, 255, 255, 255), 2.00, "default", "center", "center", false, false, false, false, false)
