...
function HilfemenueWindow()
	if(HilfemenueOpen==false)then
		if(getElementData(lp,'ElementClicked')==false)then
			...
			Hilfepanel.label[1] = guiCreateLabel(0.42, 0.05, 0.56, 0.93, "Herzlich Willkommen im Hilfemenü von Westside Roleplay. Hier erhälst du zu allen wichtigen Dingen auf unserem Server ausführlich geschriebene Informationen, welche bei Bedarf immer mal wieder eneuert werden.", true, Hilfepanel.window[1])
