...
function showRegisterGui_func ()
	...
	----- Texte -----
	gLabel[1] = guiCreateLabel(0.02, 0.08, 0.97, 0.12, "Willkommen auf Westside Roleplay! Um dich bei uns zu registrieren, fülle alle unteren Felder aus und klicke anschließend auf 'Registrieren'.", true, gWindow["register"])
