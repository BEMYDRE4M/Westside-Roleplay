...
function _CreateLoginWindow()
	...
	if LoginWindow then
		...
		logininfolabel = guiCreateLabel(0.02, 0.08, 0.97, 0.12, "Willkommen zurück auf Westside Roleplay, "..getPlayerName(localPlayer).."! Um dich einzuloggen fülle alle unteren Felder aus.", true, LoginWindow)
